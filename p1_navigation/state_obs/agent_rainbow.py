...
from state_obs.replay_buffer import ReplayBuffer, PrioritizedReplayBuffer
from state_obs.model import QDuelingNetwork
...
class Agent_Rainbow():
    ...
    def __init__(self, state_size, action_size, seed, ddqn):
